...
if __name__ == '__main__':
    ...
    parser.add_argument('--csv_path', type=str, default='/home/dpnm/cnsm2022/data/nsl-kdd/KDDTrain_binary.csv')
    parser.add_argument('--ids_path', type=str, default='/home/dpnm/cnsm2022/data/nsl-kdd/KDDTrain_binary.indices.rnn_len16.pkl')
    parser.add_argument('--stat_path', type=str, default='/home/dpnm/cnsm2022/data/nsl-kdd/KDDTrain_binary.csv.stat')
    parser.add_argument('--data_name', type=str, default='nsl-kdd/KDDTrain_binary')
